...
2. Verifiera nuvarande quizpersistens i `QuizNotifier` och `UserNotifier` innan vi lägger till mer “juice”.
...
## v1.4.1 – Belönings-MVP och garderobens första slice
...
- Ett enkelt inventory-flöde för visuella avatar-items.
- Ett belöningsdialogsteg efter nivåuppgång eller annan tydlig progression.
...
- Spaced Repetition v2 och ett första “Dagens träningsläger”.
...
- Lägg inte vald flik, knappstate, controllers eller annan route-ephemeral state i providers bara för att “allt ska vara i Riverpod”.
...
**Produktmål:** Göra hemskärmen mer levande och ge barnet ett tydligare visuellt “hem” som kan växa över tid.
...
**Varför:** TTS är ett tydligt tillgänglighetslyft och passar offline-first bättre än många andra “AI”-spår.
...
- Pluginets pausstöd på Android bygger på workaround och fungerar först från API 26+. Planera därför inte beroende logik kring “pause/resume narration” på lägre Android-versioner.
