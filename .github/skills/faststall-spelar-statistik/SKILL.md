...
- När quizstart, replay, resultat eller parent mode får nya triggers.
...
- Introducera inte fler namnvarianter som `quiz_started` vs `quiz_start` utan att synka docs och kod.
...
3. Om startfloden andras: verifiera normal start och replay/starta-igen.
