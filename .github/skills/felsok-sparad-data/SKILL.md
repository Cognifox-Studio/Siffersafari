---
name: felsok-sparad-data
description: 'Diagnose local Hive or repository persistence issues. Use when profile data does not save, quiz state disappears, adaptive difficulty looks wrong, or offline data may be corrupt.'
argument-hint: 'Beskriv vilken box, profil eller vilket sparflöde som beter sig fel.'
---
