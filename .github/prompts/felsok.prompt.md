...
## Steg:
1. Läs relevanta filer i `/memories/repo/` om de matchar felet, till exempel `/memories/repo/testing.md` vid testfel eller `/memories/repo/lottie_only_mascot_2026-03-09.md` vid mascot-krasch.
