...
class LokeWalkCharacter extends StatefulWidget {
  const LokeWalkCharacter({
    super.key,
    this.height = 140,
  ...
  @override
  State<LokeWalkCharacter> createState() => _LokeWalkCharacterState();
}

class _LokeWalkCharacterState extends State<LokeWalkCharacter>
