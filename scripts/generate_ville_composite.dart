...
<svg width="400" height="600" viewBox="0 0 400 600" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- Layer 1: Legs (bottom) -->
  <g id="legs" class="mascot-part" transform="translate(0, 250)">
    <!-- Left leg -->
    <rect x="140" y="20" 
          width="40" height="294" 
          rx="8.4" ry="8.4"
  ...
  <!-- Layer 2: Body -->
  <g id="body" class="mascot-part" transform="translate(0, 150)">
    <rect x="120" y="20" 
  ...
  <!-- Layer 4: Head -->
  <g id="head" class="mascot-part" transform="translate(0, 30)">
  ...
  <g id="eyes" class="mascot-part" transform="translate(0, 30)">
    <!-- Left eye -->
  ...
  <g id="mouth" class="mascot-part" transform="translate(0, 30)">
  ...
  <g id="antennas" class="mascot-part" transform="translate(0, 30)">
    <!-- Left antenna -->
