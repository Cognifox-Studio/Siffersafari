...
void main() async {
  print('🎨 Ville SVG Part Generator');
  print('━' * 50);
  ...
  final outputDir = Directory('assets/characters/ville/svg');
  ...
  final generator = VilleSVGGenerator(
    colors: colors,
  ...
  // Generate all parts
  final parts = {
    'ville_head': generator.generateHead(),
    'ville_eyes_open': generator.generateEyesOpen(),
    'ville_eyes_closed': generator.generateEyesClosed(),
    'ville_mouth_smile': generator.generateMouthSmile(),
    'ville_mouth_sad': generator.generateMouthSad(),
    'ville_mouth_neutral': generator.generateMouthNeutral(),
    'ville_body': generator.generateBody(),
    'ville_arm_left': generator.generateArmLeft(),
    'ville_arm_right': generator.generateArmRight(),
    'ville_leg_left': generator.generateLegLeft(),
    'ville_leg_right': generator.generateLegRight(),
    'ville_antennas': generator.generateAntennas(),
  };
