      ...
      particles.add({
        ...
        'ks': {
          ...
          'p': {
            'a': 1,
            'k': [
              {'i': {'x': 0.42, 'y': 1}, 'o': {'x': 0.58, 'y': 0}, 't': 0, 's': [startX, startY]},
              {'t': 90, 's': [startX + (random.nextDouble() * 100 - 50), endY]},
            ],
          },
          'a': {'a': 0, 'k': [0, 0]},
          's': {'a': 0, 'k': [100, 100]},
      ...
      stars.add({
        ...
        'ks': {
          ...
          's': {
            ...
            'k': [
              {'t': delay, 's': [0, 0]},
              {'t': delay + 10, 's': [120, 120]},
              {'t': delay + 30, 's': [120, 120]},
              {'t': delay + 40, 's': [0, 0]},
            ],
          },
        },
